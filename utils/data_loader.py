...
from utils.params import START, END, DEBUG
...
class TrainDataLoader(Dataset):
    ...
    def __init__(self, src_file, vocab=None):
...
class TestDataLoader:
    ...
    def __init__(self, src_file, vocab, labeled=False):
